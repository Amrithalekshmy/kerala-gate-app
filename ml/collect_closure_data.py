"""
Crowdsource gate closure duration data from users.
Adds API endpoints for users to report "gate just closed" and "gate just opened".
Logs these events to the database for training Model 2.
"""
